...
A high-performance Ludo implementation built with C++20. This project focuses on two main goals: extreme engine efficiency and a modern, good user experience.
...
*   **UI:** The frontend uses a modern CSS design system with translucent layers, micro-animations, and a refined dark mode palette. It’s built with vanilla JS/CSS for maximum control and performance.
